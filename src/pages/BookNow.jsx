            ...
            <div className="border border-gray-300 p-10 rounded-2xl">
              ...
              <div>
                <div className="flex gap-3 text-[#12345B] pt-3">
                  ...
                  <h3 className="font-bold text-lg md:textxl">
                    {" "}
                    Privacy & Consent
                  </h3>
                </div>
                <p className="text-xs md:text-sm text-[#12345B]">
                  ...
                  handled in accordance with the clinic's Privacy Policy and
                  will only be used for purposes related to my care and
                  appointment.
                </p>
              </div>
              ...
              <Link
                ...
                type="submit"
                className="w-full relative top-5 left-10 md:left-16 rounded-4xl bg-[#12345B] px-20 py-3 my-8 font-medium text-white transition hover:bg-[#164b87] "
              >
                Book Now
              </Link>
            </div>
